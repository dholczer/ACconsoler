namespace AConsoler
{
    ...
    /// <summary>
    /// Entry point for AConsoler applications
    /// </summary>
    public sealed class Consolery
    {
        ...
        /// <summary>
        /// Validates specified type and throws AConsolerException if an error
        /// </summary>
        /// <param name="targetType">Type where to search for Action methods</param>
        ...
        private void RunAction()
        {
            ...
            {
                this.notation.PrintUsage();
                throw new AConsolerException("Unknown subcommand \"{0}\"", this.args[0]);
            }
