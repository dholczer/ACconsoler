namespace AConsoler
{
    ...
    public class MetadataValidator
    {
        ...
        private static void CheckActionMethodNamesAreNotReserved(MethodBase method)
        {
            ...
            {
                throw new AConsolerException("Method name \"{0}\" is reserved. Please, choose another name", method.Name);
            }
        }
        ...
        private void IfActionMethodIsSingleCheckMethodHasParameters()
        {
            ...
            {
                throw new AConsolerException(
                    "[Action] attribute applied once to the method \"{0}\" without parameters. In this case AConsoler should not be used",
        ...
        private static void CheckRequiredAndOptionalAreNotAppliedAtTheSameTime(MethodBase method)
        {
            foreach (var parameter in method.GetParameters())
            {
                ...
                {
                    throw new AConsolerException("More than one attribute is applied to the parameter \"{0}\" in the method \"{1}\"",
